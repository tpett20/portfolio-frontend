...
function Home(props) {
    function downloadResume() {
        ...
        // Source: https://www.geeksforgeeks.org/how-to-download-pdf-file-in-reactjs/?ref=gcse
    }
        ...
        <>
            <div className="row mt-lg-5">
                <div className="col-12 col-lg-4 col-xxl-5 text-center">
                    <img className="img-fluid rounded shadow-sm" src="https://avatars.githubusercontent.com/u/125073874?v=4" alt="Thomas Pettersen Headshot" />
                </div>
            ...
            <div className="row justify-content-evenly mt-4 mt-lg-5 text-center">
                <div className="col-4 col-lg-2">
                    <a href="https://github.com/tpett20" className="home-links btn">
                ...
                <div className="col-4 col-lg-2">
                    <a href="https://leetcode.com/tpett/" className="home-links btn">
